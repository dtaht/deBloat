...
tc qdisc add dev $DEV parent 1:11 handle 20: codel noecn limit 10000 # quantum 256
tc qdisc add dev $DEV parent 1:12 handle 30: codel noecn limit 10000 # quantum 256
