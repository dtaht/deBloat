...
tc qdisc add dev $DEV parent 1:10 handle 20: codel noecn # quantum 256
tc qdisc add dev $DEV parent 1:11 handle 30: codel noecn # quantum 256
tc qdisc add dev $DEV parent 1:12 handle 40: codel noecn # quantum 256
