...
${TC} qdisc add dev $DEV parent 1:10 handle 20: efq_codel noecn quantum 1000 flows 64000

${TC} qdisc add dev $DEV parent 1:11 handle 30: efq_codel noecn quantum 1000 flows 64000
${TC} qdisc add dev $DEV parent 1:12 handle 40: efq_codel noecn quantum 1000 flows 64000
