...
${TC} qdisc add dev $IFACE root handle 1000: cbq avpkt 1000 rate $UPLOAD \
	bandwidth $UPLOAD
${TC} class add dev $IFACE parent 1000: classid 1000:1 \
	est 1sec 8sec cbq allot 3800 mpu 64 \
	rate $UPLOAD prio 1 avpkt 1000 bounded

${TC} qdisc add dev $IFACE handle 1 parent 1000:1 est 1sec 8sec qfq
